...
class FusekiBaseStrategy:
    ...
    def add_triples(self, triples: "Sequence[Triple]") -> dict:
        ...
        return self.request("POST", cmd, headers=headers, plainData=True, graph=True)
    ...
    def parse(
        ...
        **kwargs,
        ...
        self.request("POST", cmd=content, headers=headers, plainData=True, graph=True)
    ...
    def serialize(
        ...
        content = self.request("GET", prefix=False, graph=True, json=False)["response"]
